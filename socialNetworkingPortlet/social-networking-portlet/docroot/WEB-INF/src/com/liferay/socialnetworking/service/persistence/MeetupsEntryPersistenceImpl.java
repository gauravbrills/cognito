...
public class MeetupsEntryPersistenceImpl extends BasePersistenceImpl<MeetupsEntry>
	...
	public static final String FINDER_CLASS_NAME_LIST = FINDER_CLASS_NAME_ENTITY +
		".List";
	public static final FinderPath FINDER_PATH_FIND_BY_R_S = new FinderPath(MeetupsEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_R_S = new FinderPath(MeetupsEntryModelImpl.ENTITY_CACHE_ENABLED,
			MeetupsEntryModelImpl.FINDER_CACHE_ENABLED, FINDER_CLASS_NAME_LIST,
			"countByR_S", new String[] { Integer.class.getName() });
	...
	protected MeetupsEntry toUnwrappedModel(MeetupsEntry meetupsEntry) {
		...
		meetupsEntryImpl.setVersion(meetupsEntry.getVersion());
		meetupsEntryImpl.setContent(meetupsEntry.getContent());
		meetupsEntryImpl.setPriority(meetupsEntry.getPriority());
		meetupsEntryImpl.setStatus(meetupsEntry.getStatus());
		meetupsEntryImpl.setStatusByUserId(meetupsEntry.getStatusByUserId());
		meetupsEntryImpl.setStatusByUserName(meetupsEntry.getStatusByUserName());
		meetupsEntryImpl.setStatusDate(meetupsEntry.getStatusDate());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MeetupsEntry> findByR_S(int status) throws SystemException {
		return findByR_S(status, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<MeetupsEntry> findByR_S(int status, int start, int end)
		throws SystemException {
		return findByR_S(status, start, end, null);
	}
	...
	public List<MeetupsEntry> findByR_S(int status, int start, int end,
		...
		List<MeetupsEntry> list = (List<MeetupsEntry>)FinderCacheUtil.getResult(FINDER_PATH_FIND_BY_R_S,
				finderArgs, this);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsEntry findByR_S_First(int status,
		OrderByComparator orderByComparator)
		throws NoSuchMeetupsEntryException, SystemException {
		List<MeetupsEntry> list = findByR_S(status, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsEntry findByR_S_Last(int status,
		OrderByComparator orderByComparator)
		throws NoSuchMeetupsEntryException, SystemException {
		int count = countByR_S(status);

		List<MeetupsEntry> list = findByR_S(status, count - 1, count,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsEntry[] findByR_S_PrevAndNext(long meetupsEntryId,
		...
		try {
			...
			array[0] = getByR_S_PrevAndNext(session, meetupsEntry, status,
					orderByComparator, true);

			array[1] = meetupsEntry;

			array[2] = getByR_S_PrevAndNext(session, meetupsEntry, status,
	...
	protected MeetupsEntry getByR_S_PrevAndNext(Session session,
		MeetupsEntry meetupsEntry, int status,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByR_S(int status) throws SystemException {
		for (MeetupsEntry meetupsEntry : findByR_S(status)) {
			remove(meetupsEntry);
		}
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int countByR_S(int status) throws SystemException {
	...
	private static final String _FINDER_COLUMN_R_S_STATUS_2 = "meetupsEntry.status = ?";
